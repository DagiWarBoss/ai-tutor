...
# --- The root folder containing all your subject/class subdirectories ---
PDF_ROOT_FOLDER = "NCERT_PCM_ChapterWise"
# --- The name of the output file for you to review ---
OUTPUT_CSV_FILE = "extracted_headings.csv"

def get_most_common_font_info(doc):
    """
    Scans the document to find the properties of the most common font (likely the body text).
    """
    font_counts = Counter()
    for page in doc:
...
if __name__ == '__main__':
    # This list will hold all data before we write it to the CSV
    all_headings_data = []
                ...
                try:
                    ...
                    if chapter_num:
                        ...
                        if not final_headings:
                            ...
                            # Add the found headings to our main list
    ...
    # --- After processing all files, write the data to a CSV file ---
    if not all_headings_data:
        print("\nNo headings were extracted from any files. CSV file will not be created.")
    else:
        print(f"\n\n=======================================================")
        ...
        print(f"Successfully created {OUTPUT_CSV_FILE}. You can now open it to review and edit the topic names.")
        print(f"=======================================================")