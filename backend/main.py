...
from pypdf import PdfReader # Ensure you have 'pypdf' installed (pip install pypdf)
import uuid # For generating unique filenames
import shutil # For saving uploaded files temporarily
from fastapi.middleware.cors import CORSMiddleware # Needed for frontend-backend communication

# Initialize FastAPI app
app = FastAPI()

# --- CORS Configuration ---
# This is crucial for allowing your React frontend (running on a different port/domain)
# to make requests to your FastAPI backend.
origins = [
    "http://localhost",
    "http://localhost:5173",  # Replace with your frontend's actual URL/port if different
    # Add other frontend URLs if you deploy later (e.g., "https://yourfrontenddomain.com")
]
...
# These directories will be created relative to where main.py is run (i.e., inside 'backend' folder)
